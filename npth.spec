...
Version  : 1.6
Release  : 502
URL      : file:///aot/build/clearlinux/packages/npth/npth-v1.6.tar.gz
Source0  : file:///aot/build/clearlinux/packages/npth/npth-v1.6.tar.gz
...
%package staticdev
Summary: staticdev components for the npth package.
Group: Default
Requires: npth-dev = %{version}-%{release}

%description staticdev
staticdev components for the npth package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639147524
